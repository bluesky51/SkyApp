...
import com.example.bluesky.app.callback.OnAscNumListener;
import com.example.bluesky.app.callback.OnDescNumListener;
import com.example.bluesky.app.callback.OnSelectItemListener;
 ...
 */
public class ShoppingCartFragment extends Fragment implements OnAscNumListener, OnDescNumListener, OnSelectItemListener, View.OnClickListener {
   ...
   //List<ShoppingCartItem> mShoppingCartItems = new ArrayList<>();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (isLogin == false) {
            ...
            Toast.makeText(getActivity(), "请先登录在查看购物车数据", Toast.LENGTH_LONG).show();
        } else {
            tv_tip.setVisibility(View.GONE);
            QueryList();
        }
        if (shoppingCartAdapter!=null){
            shoppingCartAdapter.setOnAscNumListener(this);
            shoppingCartAdapter.setOnDescNumListener(this);
            shoppingCartAdapter.setmOnSelectItemListener(this);
